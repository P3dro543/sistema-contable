        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>CentroCosto/index">Centros de Costo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL; ?>AsignarTerceros/index">Asignar Terceros</a>
                    </li>
                    <li class="nav-item">
