...
require_once 'app/models/Tercero.php';
...
switch ($ruta) {
    ...
    case 'terceros':
        // 1. Cargamos el archivo del modelo manualmente
        require_once BASE_PATH . '/app/models/Tercero.php'; 
        
        // 2. Instanciamos y traemos datos
        $model = new Tercero();
        $data = [
            'terceros'      => $model->getTercerosPaginados(10, 0, ''), 
            'search'         => '',
            'total_paginas'  => 1,
            'pagina_actual'  => 1
        ];

        // 3. Ahora sí, la vista tendrá los datos
        include 'views/auxiliares/index.php';
